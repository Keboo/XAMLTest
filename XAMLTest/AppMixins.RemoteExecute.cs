...
public static partial class AppMixins
{
    ...
    /// <param name="param1">The first parameter.</param>
    /// <returns>A task representing the asynchronous operation.</returns>
    public static Task RemoteExecute<T>(this IApp app, Func<T, Task> action)
    {
        return app.RemoteExecute<object?>(action, []);
    }
    ...
    /// <param name="param1">The first parameter.</param>
    /// <returns>A task representing the asynchronous operation.</returns>
    public static Task RemoteExecute<T, T1>(this IApp app, Func<T, T1, Task> action, T1 param1)
    {
        return app.RemoteExecute<object?>(action, [param1]);
    }
    ...
    /// <param name="param2">The second parameter.</param>
    /// <returns>A task representing the asynchronous operation.</returns>
    public static Task RemoteExecute<T, T1, T2>(this IApp app, Func<T1, T2, Task> action, T1 param1, T2 param2)
    {
        return app.RemoteExecute<object?>(action, [param1, param2]);
    }
    ...
    /// <param name="param3">The third parameter.</param>
    /// <returns>A task representing the asynchronous operation.</returns>
    public static Task RemoteExecute<T, T1, T2, T3>(this IApp app, Func<T1, T2, T3, Task> action, T1 param1, T2 param2, T3 param3)
    {
        return app.RemoteExecute<object?>(action, [param1, param2, param3]);
    }
    ...
    /// <param name="param4">The fourth parameter.</param>
    /// <returns>A task representing the asynchronous operation.</returns>
    public static Task RemoteExecute<T, T1, T2, T3, T4>(this IApp app, Func<T1, T2, T3, T4, Task> action, T1 param1, T2 param2, T3 param3, T4 param4)
    {
        return app.RemoteExecute<object?>(action, [param1, param2, param3, param4]);
    }
    ...
    /// <param name="param5">The fifth parameter.</param>
    /// <returns>A task representing the asynchronous operation.</returns>
    public static Task RemoteExecute<T, T1, T2, T3, T4, T5>(this IApp app, Func<T1, T2, T3, T4, T5, Task> action, T1 param1, T2 param2, T3 param3, T4 param4, T5 param5)
    {
        return app.RemoteExecute<object?>(action, [param1, param2, param3, param4, param5]);
    }
    ...
    /// <param name="param6">The sixth parameter.</param>
    /// <returns>A task representing the asynchronous operation.</returns>
    public static Task RemoteExecute<T, T1, T2, T3, T4, T5, T6>(this IApp app, Func<T1, T2, T3, T4, T5, T6, Task> action, T1 param1, T2 param2, T3 param3, T4 param4, T5 param5, T6 param6)
    {
        return app.RemoteExecute<object?>(action, [param1, param2, param3, param4, param5, param6]);
    }
    ...
    /// <param name="param7">The seventh parameter.</param>
    /// <returns>A task representing the asynchronous operation.</returns>
    public static Task RemoteExecute<T, T1, T2, T3, T4, T5, T6, T7>(this IApp app, Func<T1, T2, T3, T4, T5, T6, T7, Task> action, T1 param1, T2 param2, T3 param3, T4 param4, T5 param5, T6 param6, T7 param7)
    {
        return app.RemoteExecute<object?>(action, [param1, param2, param3, param4, param5, param6, param7]);
    }
    ...
    /// <param name="param8">The eighth parameter.</param>
    /// <returns>A task representing the asynchronous operation.</returns>
    public static Task RemoteExecute<T, T1, T2, T3, T4, T5, T6, T7, T8>(this IApp app, Func<T1, T2, T3, T4, T5, T6, T7, T8, Task> action, T1 param1, T2 param2, T3 param3, T4 param4, T5 param5, T6 param6, T7 param7, T8 param8)
    {
        return app.RemoteExecute<object?>(action, [param1, param2, param3, param4, param5, param6, param7, param8]);
    }
}
