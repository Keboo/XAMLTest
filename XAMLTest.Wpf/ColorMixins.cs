...
public static class ColorMixins
{
    ...
    /// <returns></returns>
    public static float RelativeLuninance(this WpfColor color)
    {
        return
    ...
    /// <returns></returns>
    public static float ContrastRatio(this WpfColor color, WpfColor color2)
    {
    ...
    public static WpfColor FlattenOnto(this WpfColor foreground, WpfColor background)
    {
        ...
        return WpfColor.FromArgb((byte)(newAlpha * byte.MaxValue),
    ...
    public static WpfColor WithOpacity(this WpfColor color, double opacity)
        => WpfColor.FromArgb((byte)(color.A * opacity), color.R, color.G, color.B);
